...
SA mDP
SD April 2020
TO Urkesh; Temple BA; *ābi*; necromantic structure; KASKAL.KUR; Kumarbi; *kispum*; secondary burials
...
The composite structure was abandoned around 1350 BC, with the coming of the Assyrians. Very likely, the **cultic use** of the area already started during the Late Chalcolithic and the sacrality of the place during the centuries can be argued from the absence of other installations in the area. The temple itself could be connected to a **Hurrian origin**, and the dedication of a first temple by king [**Tish-atal**](https://en.wikipedia.org/wiki/Tish-atal) to [**Nergal**](https://en.wikipedia.org/wiki/Nergal) (attested on the inscriptions on two copper alloy [**lion statuettes**](https://en.wikipedia.org/wiki/Hurrian_foundation_pegs) kept at the MET and the Louvre Museum) who can be better interpreted as [**Kumarbi**](https://en.wikipedia.org/wiki/Kumarbi), the polyad deity of the ancient site.
