...
1) the presence of specific priests;

2) an offering, to the god <sup>d</sup>Kura (the polyad deity of Ebla);

3) the recurrence of specific syntagma;

4) the presence of the term *da-mi-mu* (‘reciter, lamenter’).

As stressed by the author, <<the value that these elements assume is based on the meaning of some keywords, as indicated by Ebla’s lexical lists, both on the basis of prosopographic analysis, suggests the identification of an act of worship>> (p. 131; English translation by [mDP](http://4Banks.net/Mes-rel/authorship/depietri.htm)).
