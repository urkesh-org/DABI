...
SA mDP
SD April 2020
TO Urkesh; Temple Terrace; Temple BA; Kumarbi

The report of the 18<sup>th</sup> excavation season (2005) at [**Urkesh/Tell Mozan**](http://urkesh.org/) is entirely devoted to the description and interpretation of the **Temple Terrace**, with a reconsideration of the two [**lion statuettes**](https://en.wikipedia.org/wiki/Hurrian_foundation_pegs) of [**Tish-atal**](https://en.wikipedia.org/wiki/Tish-atal) (see here, for an [overview](http://urkesh.org/urkeshpublic/temple.htm#structure)].
 
*Paragraph 1* described the **Temple Terrace** and the main goals of the season, aiming at better understanding the development of the temple (from the postulated, and later confirmed, idea of tracing back to the mid-fourth millennium BC the first foundation of [**temple BA**](http://urkesh.org/pages/037b.htm)), to gain an interpretation of the god who was worshipped therein (i.e. the polyad god [**Kumarbi**](https://en.wikipedia.org/wiki/Kumarbi)). A history of the research is sketched, describing previous excavations on the High Mound (from 1984 to 2004), providing also the elevation of **temple BA** as 470.00 m on the sea-level (*sub-paragraphs 1.1 and 1.2*); *sub-paragraph 1.3* focuses on 2005 activities, while *sub-paragraph 1.4* investigates the development and the structural components of the **Temple Terrace**: the **escarpment**, the [**Plaza JP**](http://urkesh.org/mz/a/JP/ugr/-frame.htm), the [**revetment wall J5**](http://urkesh.org/mz/a/J05/ugr/-frame.htm), the [**monumental access J2**](http://urkesh.org/mz/a/J02/ugr/-frame.htm), the **glacis** and the [**temple BA**](http://urkesh.org/pages/037b.htm) itself (the present form attested at least from 2400 to 2350 BC, according to middle chronology).
...
*Paragraph 3* focuses on other structures related to the Temple Terrace: **revetment wall**, the packing and the **glacis**, and the **escarpment**.
...
NA mDP
ND 17 June 2020
TO Urkesh; function of Temple BA; accessibility
