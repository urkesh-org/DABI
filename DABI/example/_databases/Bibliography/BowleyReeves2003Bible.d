...
This paper (derived from a previous publication; see at this [link](http://www.sbl-site.org/Newsletter/12_2001/)) aims at rethinking the concept(s) of the term **‘Bible(s)’**, on the base of past or recent discoveries (e.g. the [**Cairo Geniza**](https://en.wikipedia.org/wiki/Cairo_Geniza), the [**Oxyrhynchus papyri**](http://www.papyrology.ox.ac.uk/POxy/), the [**Nag Hammadi corpus**](https://en.wikipedia.org/wiki/Nag_Hammadi_library), other European and Middle Eastern **manuscript collections**, rabbinic and post-rabbinic **citations**, and the [**Dead Sea Scrolls**](http://orion.mscc.huji.ac.il/)).
...
4) <<we can no longer speak of ‘the [Masoretic Text](https://www.britannica.com/topic/Masoretic-text)’ as the benchmark of Hebrew texts which best represents a pristine original form>> (p. 11).
...
2) <<the history of ‘books’ in the [**Second Temple period**](https://en.wikipedia.org/wiki/Second_Temple_period) in their diverse textual forms is qualitatively similar to the hypothesized earlier developments in the composition of biblical texts by classical source criticism>> (p. 14);
