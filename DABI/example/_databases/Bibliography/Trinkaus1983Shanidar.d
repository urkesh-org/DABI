...
SA mDP
SD June 2020
TO emergence of religious/spiritual thought; Shanidar Cave; Neanderthals; early burial customs; piety

This volume describes, through 14 chapters, important archaeological discoveries in the [**Shanidar Cave**](https://en.wikipedia.org/wiki/Shanidar_Cave), located in the Erbil Governorate, in north-eastern Iraq, within the Zagros mountains. Here, archaeologists and anthropologists of the Columbia University, and later of the Washington University, uncovered graves of eight adult and two infant **Neanderthals** (ca. 65000-35000 BP), together with two late proto-Neolithic (ca. 10600 BP) cemeteries containing remains of about 35 individuals. 

Some of this graves shows relevant evidence of **burial practices** (such as the so-called [**Shanidar 4**](https://en.wikipedia.org/wiki/Shanidar_Cave#Shanidar_4,_the_%22flower_burial%22), known as the ‘flower burial’) and other clues pointing to people taking care of their aged members of the community, such as the case of [**Shanidar 1**](https://en.wikipedia.org/wiki/Shanidar_Cave#Shanidar_1), the skeleton (later named ‘Nandy’ by the archaeologists) of a male between 35 and 45 years, presenting traces of proto-surgical operations, probably indicating that this ancient Neanderthal community took care of its elder people (a good comparison to the [Dmanisi](https://en.wikipedia.org/wiki/Dmanisi) **Skull G** discovered in Georgia (here a [brief introductive video](https://www.youtube.com/watch?v=560hiKxz-eg)), belonging to an aged man with no teeth, well described in [Buccellati and Kelly Buccellati 2014](http://urkesh.org/pages/911-profondo.htm), on [pp. 23-24](http://urkesh.org/attach/GBDalProfondo.pdf#page=24)).
